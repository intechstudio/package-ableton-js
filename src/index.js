            ...
            scene.get("clip_slots").then(clip_slots => {
                clip_slots.forEach((clip_slot, clipSlotIndex) => {
                    clip_slot.get("color").then(color => {
                        console.log(`Scene ${sceneIndex} at slot ${clipSlotIndex} has color ${color === null || color === void 0 ? void 0 : color.rgb}`);
                    });
                });
            });
        });
...
function listenForAddedOrDeletedScenes() {
    return __awaiter(this, void 0, void 0, function* () {
        ableton.song.addListener("scenes", (scenes) => __awaiter(this, void 0, void 0, function* () {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const promises = scenes.map((scene, row) => {
                return scene.get('clip_slots').then((clip_slots) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    for (let col = 0; col < 4; col++) {
                        ...
                        const subscriberPromise = yield clip_slot.addListener("is_triggered", (bool) => __awaiter(this, void 0, void 0, function* () {
                            const led = { index: 3 };
...
function launchScene(rowNumber) {
    return __awaiter(this, void 0, void 0, function* () {
        const scene = yield ableton.song.get("scenes").then(scenes => scenes[rowNumber]);
        scene.fire();
    });
}
...
function setGridLedIntensity(row_1, col_1) {
    return __awaiter(this, arguments, void 0, function* (row, col, intensity = 0) {
        try {
            //BUTTON_ARRAY[row][col];
            const BUTTON = 0;
