...
function selectionListener() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    unsubList.push(
      yield ableton.song.view.addListener("selected_parameter", (parameter) =>
    ...
    unsubList.push(
      yield ableton.song.view.addListener("selected_track", (track) =>
        __awaiter(this, void 0, void 0, function* () {
          if (track) {
            selectedTrack = track;
            ...
            if (sends.length > 0) {
              sends.forEach((send, index) =>
                __awaiter(this, void 0, void 0, function* () {
                  activeTrackSendValues[index] = yield send.raw.value.toFixed(
                    2
                  );
                  unsubList.push(
                    yield send.addListener("value", (v) => {
            ...
            unsubList.push(
              yield panning.addListener("value", (v) => {
            ...
            if (yield track.get("can_be_armed")) {
              ...
              unsubList.push(
                yield track.addListener("arm", (data) => {
            ...
            if (track.raw.id !== masterTrack.raw.id) {
              ...
              unsubList.push(
                yield track.addListener("mute", (data) => {
            ...
            if (track.raw.id !== masterTrack.raw.id) {
              ...
              unsubList.push(
                yield track.addListener("solo", (data) => {
            ...
            if (
              currentIndex !== SESSION_RING.track_offset &&
              currentIndex !== -1
            ) {
...
function autoResetActiveProperty() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (activeProperty == "lastTouched") {
      if (selectedParameter) {
        const defaultPropValue = yield selectedParameter.parameter.get(
          "default_value"
        );
        if (defaultPropValue) {
...
function navigate(direction) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      yield ableton.song.view.set(
        "selected_track",
        allTracks[nextIndex].raw.id
      );
