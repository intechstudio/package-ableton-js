...
class RingManager {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const track of added) {
                try {
                    ...
                    console.warn(`[RingManager] Failed to subscribe to track ${track.raw.id} (may be invisible):`, err);
                }
            }
    ...
    subscribeRingTrack(track) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rawVolumeParam = yield mixer.get("volume");
            if ((rawVolumeParam === null || rawVolumeParam === void 0 ? void 0 : rawVolumeParam.raw) != null) {
            ...
            const rawPanningParam = yield mixer.get("panning");
            if ((rawPanningParam === null || rawPanningParam === void 0 ? void 0 : rawPanningParam.raw) != null) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const trackId of this.currentRingTrackIds) {
                ...
                try {
                    ...
                    console.warn(`[RingManager] Failed to resubscribe sends for track ${trackId} (may be invisible):`, err);
                }
            }
