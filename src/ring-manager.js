...
class RingManager {
  ...
  init() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield this.globalSubs.add(
        "song:tracks",
        yield this.ableton.song.addListener("tracks", (tracks) =>
      ...
      yield this.globalSubs.add(
        ...
        yield this.ableton.song.view.addListener(
          "selected_parameter",
          (param) =>
            __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        const initialParam =
          yield this.ableton.song.view.get("selected_parameter");
        if (initialParam) {
      ...
      yield this.globalSubs.add(
        "song:is_playing",
        yield this.ableton.song.addListener("is_playing", (value) => {
      ...
      yield this.globalSubs.add(
        "song:record_mode",
        yield this.ableton.song.addListener("record_mode", (value) => {
  ...
  setupRing(numTracks_1, numScenes_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function* (numTracks, numScenes, trackOffset = 0, sceneOffset = 0) {
  ...
  setVolume(ringIndex, value) {
    ...
    if (!track) return;
    const state = this.trackStates.get(track.raw.id);
    if (state === null || state === void 0 ? void 0 : state.isMidi) return;
  ...
  sendActivePropertyState() {
    ...
    if (this.activeProperty === "selected_parameter") {
      ...
      for (const trackId of this.currentRingTrackIds) {
        ...
        if (!state) continue;
        const i =
          (_a = this.ringIndexByTrackId.get(trackId)) !== null && _a !== void 0
            ? _a
            : 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        yield this.globalSubs.add(
          ...
          yield param.addListener("value", (v) => {
  ...
  subscribeSelectedTrack(track) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield this.globalSubs.add(
        ...
        yield track.addListener("name", (value) => {
          var _a;
          this.selectedTrackName = value;
          const ri =
            (_a = this.ringIndexByTrackId.get(trackId)) !== null &&
            _a !== void 0
              ? _a
              : -1;
          this.sendMessage({
      ...
      yield this.globalSubs.add(
        ...
        yield track.addListener("color", (value) => {
          var _a, _b, _c, _d;
          const rawHex =
            typeof value === "number"
              ? value
              : (_c =
                    (_a =
                      value === null || value === void 0
                        ? void 0
                        : value.numberRepresentation) !== null && _a !== void 0
                      ? _a
                      : (_b =
                            value === null || value === void 0
                              ? void 0
                        ...
                        ? void 0
                        : _b.call(value)) !== null && _c !== void 0
                ? _c
                : 0;
          this.selectedTrackColor = hexToRgb(rawHex);
          const ri =
            (_d = this.ringIndexByTrackId.get(trackId)) !== null &&
            _d !== void 0
              ? _d
              : -1;
          this.sendMessage({
  ...
  subscribePlayingClip(track) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.playingClipName = "";
      this.playingClipColor = [0, 0, 0];
      const handleSlotIndex = (slotIndex) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b, _c;
          ...
          try {
            ...
            const colorRgb = (
              clipColor === null || clipColor === void 0
                ? void 0
                : clipColor.rgb
            )
              ? [
                  (_a = clipColor.rgb.r) !== null && _a !== void 0 ? _a : 0,
                  (_b = clipColor.rgb.g) !== null && _b !== void 0 ? _b : 0,
                  (_c = clipColor.rgb.b) !== null && _c !== void 0 ? _c : 0,
                ]
              : typeof clipColor === "number"
                ? hexToRgb(clipColor)
                : [0, 0, 0];
            this.playingClipName =
              clipName !== null && clipName !== void 0 ? clipName : "";
            ...
            yield this.globalSubs.add(
              ...
              yield clip.addListener("name", (value) => {
            ...
            yield this.globalSubs.add(
              ...
              yield clip.addListener("color", (value) => {
                var _a, _b, _c;
                const rgb = (
                  value === null || value === void 0 ? void 0 : value.rgb
                )
                  ? [
                      (_a = value.rgb.r) !== null && _a !== void 0 ? _a : 0,
                      (_b = value.rgb.g) !== null && _b !== void 0 ? _b : 0,
                      (_c = value.rgb.b) !== null && _c !== void 0 ? _c : 0,
                    ]
                  : typeof value === "number"
                    ? hexToRgb(value)
                    : (() => {
                        ...
                        const rawHex =
                          (_c =
                            (_a =
                              value === null || value === void 0
                                ? void 0
                                : value.numberRepresentation) !== null &&
                            _a !== void 0
                              ? _a
                              : (_b =
                                    value === null || value === void 0
            ...
            console.warn(
              "[RingManager] Failed to fetch playing clip info:",
              err,
            );
          }
        });
  ...
  syncRingListeners() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const removed = this.currentRingTrackIds.filter(
        (id) => !newIdSet.has(id),
      );
  ...
  subscribeRingTrack(track) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield track.addListener("name", (value) => {
          ...
          if (i !== undefined) {
            this.sendMessage({
              ...
              name: value,
              color:
                (_a = s === null || s === void 0 ? void 0 : s.color) !== null &&
                _a !== void 0
                  ? _a
                  : [0, 0, 0],
              isMidi:
                (_b = s === null || s === void 0 ? void 0 : s.isMidi) !==
                  null && _b !== void 0
                  ? _b
                  : false,
            });
        ...
        yield track.addListener("color", (value) => {
          ...
          if (i !== undefined) {
            this.sendMessage({
              ...
              i,
              name:
                (_d = s === null || s === void 0 ? void 0 : s.name) !== null &&
                _d !== void 0
                  ? _d
                  : "",
              color: rgb,
              isMidi:
                (_e = s === null || s === void 0 ? void 0 : s.isMidi) !==
                  null && _e !== void 0
                  ? _e
                  : false,
            });
      ...
      if (!isMaster) {
        ...
        yield this.ringSubs.add(
          `track:${id}:mute`,
          yield track.addListener("mute", (value) => {
            const s = this.trackStates.get(id);
            if (s) s.mute = value;
            const i = idx();
            if (i !== undefined) {
      ...
      if (!isMaster) {
        ...
        yield this.ringSubs.add(
          `track:${id}:solo`,
          yield track.addListener("solo", (value) => {
            const s = this.trackStates.get(id);
            if (s) s.solo = !!value;
            const i = idx();
            if (i !== undefined) {
      ...
      if (canArm) {
        ...
        yield this.ringSubs.add(
          `track:${id}:arm`,
          yield track.addListener("arm", (value) => {
            const s = this.trackStates.get(id);
            if (s) s.arm = !!value;
            const i = idx();
            if (i !== undefined) {
      ...
      if (!trackIsMidi) {
        ...
        yield this.ringSubs.add(
          `track:${id}:volume`,
          yield volumeParam.addListener("value", (value) => {
            const s = this.trackStates.get(id);
            if (s) s.volume = value;
            const i = idx();
            if (i !== undefined) {
        ...
        yield this.ringSubs.add(
          `track:${id}:panning`,
          yield panningParam.addListener("value", (value) => {
            const s = this.trackStates.get(id);
  ...
  requestFullState() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        const selectedTrack =
          yield this.ableton.song.view.get("selected_track");
        if (selectedTrack) {
          const trackIndex = this.allTracks.findIndex(
          ...
          const ringIdx =
            trackIndex !== -1
              ? (_a = this.ringIndexByTrackId.get(selectedTrack.raw.id)) !==
                  null && _a !== void 0
                ? _a
                : -1
              : -1;
